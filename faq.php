...
<div class="div1">
    ...
    <p class="bold">How do you make the inventory tables? What do you need from me to get started?</p>
    ...
    <div class="text_blocks">
        <p class="bold">What industries do you create the inventory displays for?</p>
...
<div class="div1">
    <div class="text_blocks">
    <p class="bold">How much does it cost?</p>
    ...
    <div class="text_blocks">
    <p class="bold">How long do the inventory take to set-up?</p>
